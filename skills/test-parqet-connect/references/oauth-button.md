# Parqet OAuth Button Snippet

Use this when you need a standard "Connect with Parqet" button. Replace placeholders and generate the authorize URL on the server (recommended) or via OAuth server metadata.
